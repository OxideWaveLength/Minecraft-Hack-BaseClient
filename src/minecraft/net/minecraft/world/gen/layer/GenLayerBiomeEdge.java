...
public class GenLayerBiomeEdge extends GenLayer {
	...
	/**
	 * Creates a border around a biome if necessary, e.g. A transition from hot to
	 * cold climates would otherwise occur.
	 */
	...
	/**
	 * Returns if two biomes can logically be neighbors. If one is hot and the other
	 * cold, for example, it returns false.
	 */
