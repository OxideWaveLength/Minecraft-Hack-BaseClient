...
public class StructureBoundingBox {
	...
	/**
	 * Create a bounding box with the specified dimensions and rotate it. Used to
	 * project a possible new component Bounding Box - to check if it would cut
	 * anything already spawned
	 */
