...
public class FloatComp extends Comp {
    ...
    public FloatComp(Value value, Module m ,int width, int height, int x, int y) {
        this.width = width;
        this.height = height;
        this.value = value;
        this.m = m;
    ...
    public boolean isNumber(char str) {
        boolean r = false;
        try {
            Float doub = Float.parseFloat(String.valueOf(str));
            r = true;
